const navigation = {
  activities: [
    ...
    { name: 'Beach Yoga', href: '#' },
    { name: 'Beach Volleyball', href: '#' },
  ],
  destinations: [
    { name: 'Popular Beaches', href: '#' },
    { name: 'Hidden Gems', href: '#' },
    { name: 'Family Beaches', href: '#' },
    { name: 'Surf Spots', href: '#' },
  ],
  company: [
    { name: 'About', href: '#' },
    { name: 'Blog', href: '#' },
...
export default function Footer() {
  return (
    <footer aria-labelledby="footer-heading" className="bg-blue-900">
      ...
      <div className="mx-auto max-w-7xl px-6 pb-6 pt-12 sm:pt-16 lg:px-8 lg:pt-20">
        <div className="xl:grid xl:grid-cols-3 xl:gap-12">
          <div className="space-y-6">
            <div className="xl:mt-0">
              <h3 className="text-base font-semibold leading-6 text-gray-300">Get Beach Updates</h3>
              <p className="mt-2 text-base leading-6 text-gray-400">
                Subscribe for the latest beach activities, travel tips and destination guides.
              </p>
              <form className="mt-4 sm:flex sm:max-w-md">
                ...
                <div className="mt-3 sm:ml-4 sm:mt-0 sm:flex-shrink-0">
                  <button
                    type="submit"
                    className="flex w-full items-center justify-center rounded-md bg-blue-600 px-3 py-2 text-base font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600"
                  >
                    Subscribe
                  </button>
                </div>
          ...
          <div className="mt-12 ml-10 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="text-base font-semibold leading-6 text-white">Activities</h3>
              ...
              <div className="mt-8 md:mt-0">
                <h3 className="text-base font-semibold leading-6 text-white">Destinations</h3>
                <ul role="list" className="mt-4 space-y-3">
        ...
        <div className="mt-12 border-t border-white/10 pt-6 sm:mt-16">
          <p className="text-sm leading-5 text-gray-400">&copy; 2024 Coast Finder. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
